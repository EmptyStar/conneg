    ...
    local values = {
     ...
     index = 0,
      ...
      captureTypeChar = function(v,c)
        v.current.type = v.current.type .. string.lower(c)
      end,

      captureSubtypeChar = function(v,c)
        v.current.subtype = v.current.subtype .. string.lower(c)
      end,

      captureParameterName = function(v,c)
        v.current.parameterName = v.current.parameterName .. string.lower(c)
      end,

      captureParameterValue = function(v,c)
        v.current.parameterValue = v.current.parameterValue .. string.lower(c)
      end,
